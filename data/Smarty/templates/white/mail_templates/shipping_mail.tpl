...
　【時間帯指定】　　<!--{$shipping.shipping_time|default:"希望なし"}-->
　【お届け日】　　　<!--{$shipping.shipping_date|date_format:"%Y/%m/%d"|default:"希望なし"}-->
　【伝票番号】　　<!--{$shipping.shipping_num|default:""}-->
　【荷物問合せURL】 <!--{$arrDelivConfUrl[$shipping.deliv_id]}-->
...
★商品は<!--{$arrDeliv[$shipping.deliv_id]}-->にてお届けします★

なお、このメールに伝票番号の記載がない場合は、
お手数をおかけいたしますが、下記の「マイページ」から
伝票番号の確認をしていただきますようお願いいたします。
