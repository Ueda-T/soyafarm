        ...
        <form name="form1" id="form1" method="post" action="?">
            ...
            <div class="btn_area">
                <ul>
                    ...
                    <li>
                    <a href="javascript:void(0);" onclick="document.form1.submit();return false;"><img src="<!--{$TPL_URLPATH}-->img/button/btn_address_select.jpg" alt="選択したお届け先に送る" class="box190" name="send_button" id="send_button" class="swp" /></a>
                    </li>
                </ul>
            </div>
        </form>
