    ...
    <item>
        ...
        <description><![CDATA[
            <div class="hproduct">
                ...
                <div><!--{$smarty.const.NORMAL_PRICE_TITLE}-->：
                    <span class="price">
                        <!--{if $arrProduct[cnt].price01_min == $arrProduct[cnt].price01_max}-->
                            <!--{$arrProduct[cnt].price01_min|sfCalcIncTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->
                        <!--{else}-->
                            <!--{$arrProduct[cnt].price01_min|sfCalcIncTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->〜<!--{$arrProduct[cnt].price01_max|sfCalcIncTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->
                        <!--{/if}-->円</span>
                </div>
