...
<h2 class="spNaked">セノビックまとめて購入ページ</h2>
<!--{if count($arrProducts) > 0 }-->
<h1><img src="<!--{$smarty.const.ROOT_URLPATH}-->image/senobic/title.gif" width="100%" alt="成長期応援飲料セノビック"/></h1>
<p style="margin:15px 0;">セノビックは、1袋からご購入いただけるようになりました！お好きな味ごとに、ご注文袋数を指定して、ご購入数を選択してご注文ください。</p>

<p style="margin:10px 0;"><img src="<!--{$smarty.const.ROOT_URLPATH}-->image/senobic/display_matome_sp.gif" width="100%" alt="セノビックは、おまとめ買いがお得！"/></p>


    <!--{* エラーメッセージ *}-->
    <p class="attention"><!--{$tpl_err_msg|h}--></p>
		...
		<td class="goodsInfo">
			<div class="linkbox clearfix">
				<dl>
                    ...
                    <dt>
<a href="<!--{$smarty.const.P_DETAIL_URLPATH}--><!--{$arrProduct.product_id|u}-->" name="product<!--{$arrProduct.product_id}-->"><!--{$arrProduct.name|h}--><img src="<!--{$TPL_URLPATH}-->img/rohto/icon_link08.png" alt="" width="11" height="11"></a>
                    </dt>
					<!--★画像★-->
...
<!--{if $tpl_customer_kbn != $smarty.const.CUSTOMER_KBN_EMPLOYEE}-->
<p class="nakedC" style="margin:20px 0 0 0;">
<a href="javascript:void(0);" onclick="fnSetVal('regular_flg', '1'); document.form1.submit(); return false;"><img src="<!--{$TPL_URLPATH}-->img/rohto/teiki.gif" alt="定期購入する" style="width:192px; height:32px;" /></a>
</p>
<!--{/if}-->

<p class="nakedC" style="margin:10px 0 20px 0;">
<a href="javascript:void(0);" onclick="fnSetVal('regular_flg', '0'); document.form1.submit();return false;" name="cart"><img src="<!--{$TPL_URLPATH}-->img/rohto/cart.gif" alt="カートに入れる" style="width:192px; height:32px;" /></a>
</p>
...
<img src="<!--{$smarty.const.ROOT_URLPATH}-->image/senobic/senobic_cart_shaker_sp.gif" width="100%" alt=""/>
