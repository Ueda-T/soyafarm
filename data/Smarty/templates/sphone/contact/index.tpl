      ...
      <input type="hidden" name="<!--{$smarty.const.TRANSACTION_ID_NAME}-->" value="<!--{$transactionid}-->" />
       <input type="hidden" name="mode" value="confirm" />
        ...
        <dl class="form_entry">
         ...
         <dt>お名前&nbsp;<img src="<!--{$TPL_URLPATH}-->img/rohto/icon_hisu.gif" alt="必須" /></dt>
           <dd><span class="attention"><!--{$arrErr.name}--></span>
             ...
             <dt>メールアドレス&nbsp;<img src="<!--{$TPL_URLPATH}-->img/rohto/icon_hisu.gif" alt="必須" /></dt>
          ...
          <dt>電話番号&nbsp;<img src="<!--{$TPL_URLPATH}-->img/rohto/icon_hisu.gif" alt="必須" /></dt>
            <dd><span class="attention"><!--{$arrErr.tel}--></span>
             ...
             <dt>内容&nbsp;<img src="<!--{$TPL_URLPATH}-->img/rohto/icon_hisu.gif" alt="必須" /></dt>
         ...
         <div class="btn_area">
             <input type="submit" value="確認ページへ" class="btnOrange" name="confirm" id="confirm" />
         </div>
     </form>
</section>
<!--▲CONTENTS-->
