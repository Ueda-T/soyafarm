...
<!--{/if}-->
<li><a rel="external" href="<!--{$smarty.const.CART_URLPATH|h}-->"><img src="<!--{$TPL_URLPATH}-->img/button/btn_footer_cart_off.png" alt="カート" width="75" height="50" /></a></li>
<!--{*
<li><a rel="external" href="<!--{$smarty.const.HTTP_URL}-->"><img src="<!--{$TPL_URLPATH}-->img/button/btn_footer_home_off.png" alt="HOME" width="75" height="50" /></a></li>
*}-->
</ul>
