    ...
    <table id="basis-index-func">
        <tr>
            ...
            <td>
                ...
                <input type="text" id="spin1" name="tax" value="<!--{$arrForm.tax|h}-->" maxlength="<!--{$smarty.const.PERCENTAGE_LEN}-->" size="6" class="box6" style="<!--{if $arrErr.tax != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" /> ％
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" id="spin2" name="free_rule" value="<!--{$arrForm.free_rule|h}-->" maxlength="<!--{$smarty.const.PRICE_LEN}-->" size="6" class="box6" style="<!--{if $arrErr.free_rule != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" /> 円(税込)以上購入時無料
            </td>
        </tr>
        <!--{*
        <tr>
            <th>送料無料条件(社員用)</th>
            <td>
                <span class="attention"><!--{$arrErr.free_rule2}--></span>
                <input type="text" id="spin2" name="free_rule2" value="<!--{$arrForm.free_rule2|h}-->" maxlength="<!--{$smarty.const.PRICE_LEN}-->" size="6" class="box6" style="<!--{if $arrErr.free_rule2 != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" /> 円(税込)以上購入時無料
            </td>
        </tr>
        *}-->
        <tr>
            <th>送料(税込)<span class="attention"> *</span></th>
            <td>
                <span class="attention"><!--{$arrErr.deliv_fee}--></span>
                <input type="text" id="spin2" name="deliv_fee" value="<!--{$arrForm.deliv_fee|h}-->" maxlength="<!--{$smarty.const.PRICE_LEN}-->" size="6" class="box6" style="<!--{if $arrErr.deliv_fee != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" />円
            </td>
        </tr>
        <!--{*
        <tr>
            <th>送料 クール便(税込)<span class="attention"> *</span></th>
            <td>
                <span class="attention"><!--{$arrErr.cool_deliv_fee}--></span>
                <input type="text" id="spin2" name="cool_deliv_fee" value="<!--{$arrForm.cool_deliv_fee|h}-->" maxlength="<!--{$smarty.const.PRICE_LEN}-->" size="6" class="box6" style="<!--{if $arrErr.cool_deliv_fee != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" />円
            </td>
        </tr>
        *}-->
        <!--{*
        <tr>
            ...
            <td>
                ...
                <input type="text" id="spin3" name="downloadable_days" value="<!--{$arrForm.downloadable_days|h}-->" maxlength="<!--{$smarty.const.DOWNLOAD_DAYS_LEN}-->" size="6" class="box6" style="<!--{if $arrErr.downloadable_days != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}--><!--{/if}-->" /> 日間有効
    ...
    <table id="basis-index-func">
        <tr>
            ...
            <td>
                ...
                緯度: <input type="text" name="latitude" value="<!--{$arrForm.latitude|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" class="box25" style="<!--{if $arrErr.latitude != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" id="latitude" />
                経度: <input type="text" name="longitude" value="<!--{$arrForm.longitude|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" class="box25" style="<!--{if $arrErr.longitude != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" id="longitude" />
                <div style="margin-top: 5px;">
                    <a class="btn-normal" href="javascript:;" name="codeAddress" id="codeAddress" onclick="">住所より自動取得</a>
<!--{* jQuery v1.9.1へのバージョンアップ時に動かなかったためコメントアウト
