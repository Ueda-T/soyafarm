        ...
        <colgroup width="80%">
            ...
            <tr>
                ...
                <td>
                    ...
                    <!--{else}-->
                        ...
                        <span class="attention"><!--{$arrErr[$key]}--></span>
                        <input type="text" id="spin1" name="<!--{$arrForm[$key].keyname}-->" value="<!--{$arrForm[$key].value|h}-->" size="10" class="box10" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" />
                        円
                    <!--{/if}-->
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <input type="text" id="spin2" name="<!--{$arrForm[$key_from].keyname}-->" value="<!--{$arrForm[$key_from].value|h}-->" size="10" class="box10" maxlength="<!--{$arrForm[$key_from].length}-->" style="<!--{$arrErr[$key_from]|sfGetErrorColor}-->" />
                    円
                    ～
                    <input type="text" id="spin3" name="<!--{$arrForm[$key_to].keyname}-->" value="<!--{$arrForm[$key_to].value|h}-->" size="10" class="box10" maxlength="<!--{$arrForm[$key_to].length}-->" style="<!--{$arrErr[$key_to]|sfGetErrorColor}-->" />
                    円
                </td>
            </tr>
            <tr>
