...
$(document).ready(function() {
    ...
    $('#tel01, #tel02, #tel03, #fax01, #fax02, #fax03').autotab_magic().autotab_filter({
        format: 'numeric',
    });
});
</script>
...
<tr>
    <th>お名前<img align="right" src="<!--{$TPL_URLPATH}-->img/icon/ico_must.gif" alt="必須" /></th>
    <td>
...
<tr>
    <th>お名前(フリガナ)<img align="right" src="<!--{$TPL_URLPATH}-->img/icon/ico_must.gif" alt="必須" /></th>
    <td>
...
<tr>
    <th>郵便番号<img align="right" src="<!--{$TPL_URLPATH}-->img/icon/ico_must.gif" alt="必須" /></th>
    <td>
        ...
        <!--{if $arrErr[$key1] || $arrErr[$key2]}-->
            <div class="attention"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></div>
        <!--{/if}-->
        <p class="top">〒&nbsp;<input type="text" name="<!--{$key1}-->" id="zip01" value="<!--{$arrForm[$key1]|h}-->" maxlength="<!--{$smarty.const.ZIP01_LEN}-->" size="<!--{$smarty.const.ZIP01_LEN}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->; ime-mode: disabled;" class="box60" />&nbsp;-&nbsp;<input type="text" name="<!--{$key2}-->" id="zip02" value="<!--{$arrForm[$key2]|h}-->" maxlength="<!--{$smarty.const.ZIP02_LEN}-->" size="<!--{$smarty.const.ZIP02_LEN}-->" style="<!--{$arrErr[$key2]|sfGetErrorColor}-->; ime-mode: disabled;" class="box60" />&nbsp;
...
<tr>
    <th>住所<img align="right" src="<!--{$TPL_URLPATH}-->img/icon/ico_must.gif" alt="必須" /></th>
    <td>
...
<tr>
    <th>電話番号<img align="right" src="<!--{$TPL_URLPATH}-->img/icon/ico_must.gif" alt="必須" /></th>
    <td>
        ...
        <!--{/if}-->
        <input type="text" name="<!--{$key1}-->" id="tel01" value="<!--{$arrForm[$key1]|h}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" size="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->; ime-mode: disabled;" class="box60" />&nbsp;-&nbsp;<input type="text" name="<!--{$key2}-->" id="tel02" value="<!--{$arrForm[$key2]|h}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" size="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr[$key2]|sfGetErrorColor}-->; ime-mode: disabled;" class="box60" />&nbsp;-&nbsp;<input type="text" name="<!--{$key3}-->" id="<!--{$key3}-->" value="<!--{$arrForm[$key3]|h}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" size="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr[$key3]|sfGetErrorColor}-->; ime-mode: disabled;" class="box60" />
    </td>
</tr>
<!--{if $flgFields > 1}-->
    <tr>
        ...
        <td>
            ...
            <!--{if $arrErr[$key1] || $arrErr[$key2] || $arrErr[$key3]}-->
                <div class="attention"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--><!--{$arrErr[$key3]}--></div>
            <!--{/if}-->
            <input type="text" name="<!--{$key1}-->" id="fax01" value="<!--{$arrForm[$key1]|h}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" size="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr[$key1]|sfGetErrorColor}-->; ime-mode: disabled;" class="box60" />&nbsp;-&nbsp;<input type="text" name="<!--{$key2}-->" id="fax02" value="<!--{$arrForm[$key2]|h}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" size="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr[$key2]|sfGetErrorColor}-->; ime-mode: disabled;" class="box60" />&nbsp;-&nbsp;<input type="text" name="<!--{$key3}-->" id="fax03" value="<!--{$arrForm[$key3]|h}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" size="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr[$key3]|sfGetErrorColor}-->; ime-mode: disabled;" class="box60" />
        </td>
    </tr>
    <tr>
        <th>メールアドレス<img align="right" src="<!--{$TPL_URLPATH}-->img/icon/ico_must.gif" alt="必須" /></th>
        <td>
    ...
    <!--{/if}-->
    <tr>
        <th>性別<img align="right" src="<!--{$TPL_URLPATH}-->img/icon/ico_must.gif" alt="必須" /></th>
        <td>
    ...
    <!--{if $flgFields > 2}-->
        <tr>
            <th>希望するパスワード<img align="right" src="<!--{$TPL_URLPATH}-->img/icon/ico_must.gif" alt="必須" /><br />
            </th>
            <td>
        ...
        <tr>
            <th>パスワードを忘れた時のヒント<img align="right" src="<!--{$TPL_URLPATH}-->img/icon/ico_must.gif" alt="必須" /></th>
            <td>
        ...
        <tr>
            <th>メールマガジン送付について<img align="right" src="<!--{$TPL_URLPATH}-->img/icon/ico_must.gif" alt="必須" /></th>
            <td>
