...
// 2011.5.11 add カスタマイズ定数読み込み
require_once DATA_REALDIR . 'customize_constants.php';
// 2011.5.11 add end

// CLICK ANALYZER タグ設定ファイル読み込み
require_once DATA_REALDIR . 'click_analyzer.php';

// 計測タグ設定ファイル読み込み
require_once DATA_REALDIR . 'tag_set.php';
