...
//        $url = $array["TARGET_HOST_" . $connection_conf_data["TARGET_PROTOCOL"]];              // 通信先URL
//
//        // 接続先の情報と送信するデータ内容をログ出力 2010.02.19 add Lincrea
...
//        $connection_conf_data["TARGET_PATH"] = $url_array["path"]; // 通信先サーバのパス
        // User-Agent情報を生成
        $user_agent =
            "VeriTrans 3GMDK/" . $array[TGMDK_Config::MDK_VERSION] . "/" .
            $array[TGMDK_Config::MDK_DTO_VERSION] . " (PHP " . phpversion() . "; " .")";
