 ...
 * @version     $Id: suica_mail_pc.tpl 14 2011-07-27 11:24:43Z hira $
...
<form method="post" action="<!--{$smarty.server.PHP_SELF|h}-->">
  ...
  <!--{/if}-->
  ■ PCメールアドレス<font color="#FF0000">※</font><br />
  ...
  <font color="#FF0000">「入力したアドレスへ送信」のボタンを押す前にお使いのPCメーラーのメールフィルタ設定をご確認下さい。<br/>設定によってはお支払い方法についてのメールが受信できない場合があります。</font>
  </p>
