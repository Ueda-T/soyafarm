                        ...
                        <!--{section name=cnt loop=$arrOrder max=$dispNumber}-->
                            ...
                            <div class="arrowBox">
                                <p>
                                    ...
                                    <em>注文番号：</em><span class="order_id"><!--{$arrOrder[cnt].shoporder_no|h}--></span><br />
                                    <!--{assign var=payment_id value="`$arrOrder[cnt].payment_id`"}-->
                                    <em>商品名：</em><span class="create_date">                                    
                                    ...
                                    <!--{if $smarty.const.MYPAGE_ORDER_STATUS_DISP_FLAG }-->
                                        ...
                                        <!--{/if}-->
                                    <!--{/if}-->
                                    <a href="#" onclick="fnModeSubmit('regular_order', 'order_id', '<!--{$arrOrder[cnt].order_id|h}-->'); return false;">再申込み</a><br />
<!--
                                    <!--{if $order_status_id != $smarty.const.ORDER_CANCEL }-->
                                    <a href="javascript:;" onclick="doCancel('<!--{$arrOrder[cnt].shoporder_no|h}-->', '<!--{$arrOrder[cnt].order_id|h}-->'); return false;">キャンセル</a>
                                    <!--{/if}-->
-->
