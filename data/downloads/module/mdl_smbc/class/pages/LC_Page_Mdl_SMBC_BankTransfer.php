 ...
 * @package Page
 */
class LC_Page_Mdl_SMBC_BankTransfer extends LC_Page_Ex {
    ...
    function makeParam($arrParam) {
        // 決済手段区分
        $arrParam['bill_method'] = MDL_SMBC_BANK_TRANSFER_BILL_METHOD;

        // 決済種類コード。
        $arrParam['kessai_id'] = MDL_SMBC_BANK_TRANSFER_KESSAI_ID;
