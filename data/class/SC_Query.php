 ...
 * @version $Id: SC_Query.php 91 2012-04-11 04:39:04Z hira $
 */
class SC_Query {
...
GC_Utils_Ex::gfPrintLog($sqlse);
    ...
    function prepare($sql, $types = null, $result_types = MDB2_PREPARE_RESULT) {
        ...
        if (PEAR::isError($sth)) {
            ...
            error_log($this->traceError($sth, $sql), 1, DB_ERROR_MAIL_TO);
    ...
    function execute(&$sth, $arrVal = array()) {
        ...
        if(defined('SQL_QUERY_LOG_MODE') && SQL_QUERY_LOG_MODE == true) {
            ...
            if(defined('SQL_QUERY_LOG_MIN_EXEC_TIME') && $timeExecTime >= (float)SQL_QUERY_LOG_MIN_EXEC_TIME) {
                ...
                error_log($logMsg, 1, DB_ERROR_MAIL_TO);
            }
        }
        ...
        if (PEAR::isError($affected)) {
            ...
            error_log($this->traceError($affected, $sql), 1, DB_ERROR_MAIL_TO);
