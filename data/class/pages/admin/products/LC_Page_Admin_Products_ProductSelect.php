 ...
 * @version $Id: LC_Page_Admin_Products_ProductSelect.php 91 2012-04-11 04:39:04Z hira $
 */
class LC_Page_Admin_Products_ProductSelect extends LC_Page_Admin_Ex {
    ...
    function lfInitParam(&$objFormParam) {
        ...
        $objFormParam->addParam("商品名", "search_name", STEXT_LEN, '');
        $objFormParam->addParam("商品コード", "search_product_code", STEXT_LEN, '');
    }
