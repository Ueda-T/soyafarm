...
class LC_Page_Admin_Basis extends LC_Page_Admin_Ex {
    ...
    function lfInitParam(&$objFormParam, $post) {
        ...
        $objFormParam->addParam("送料無料条件(一般用)", "free_rule", PRICE_LEN, 'n', array("NUM_CHECK", "MAX_LENGTH_CHECK"));
        $objFormParam->addParam("送料無料条件(社員用)", "free_rule2", PRICE_LEN, 'n', array("NUM_CHECK", "MAX_LENGTH_CHECK"));
        $objFormParam->addParam("送料 通常便(税込)",   "deliv_fee", PRICE_LEN, 'n', array("EXIST_CHECK", "NUM_CHECK", "MAX_LENGTH_CHECK"));
        $objFormParam->addParam("送料 クール便(税込)", "cool_deliv_fee", PRICE_LEN, 'n', array("EXIST_CHECK", "NUM_CHECK", "MAX_LENGTH_CHECK"));
