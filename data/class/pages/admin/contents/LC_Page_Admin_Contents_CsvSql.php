 ...
 * @version $Id: LC_Page_Admin_Contents_CsvSql.php 91 2012-04-11 04:39:04Z hira $
 */
    ...
    function action() {
        ...
        case 'confirm':
            ...
            if(SC_Utils_Ex::isBlank($this->arrErr)) {
                ...
                // データの更新
                $this->arrForm['sql_id'] =
                    $this->lfUpdData($objFormParam->getValue('sql_id'),
                        $objFormParam->getDbArray()
                    );
...
ORDER BY sql_id
EOF;
        return $objQuery->getAll($sql,$arrVal);
    }
