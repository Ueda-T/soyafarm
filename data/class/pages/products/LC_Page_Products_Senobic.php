...
class LC_Page_Products_Senobic extends LC_Page_Ex
{
    /*
     */
    function init() {
        ...
        $this->tpl_mainpage = "senobic.tpl";
        $this->tpl_title = "セノビックおまとめ購入ページ";
    }
	...
	if ($_GET[CAMPAIGN_PARAM_STR]) {
		...
		if (isset($CLICK_ANALYZER_STATIC["senobic"])) {
		    $this->tpl_clickAnalyzer = $CLICK_ANALYZER_STATIC["senobic"];
        }
