...
*/
    ...
    case "tran" :
        ...
        $utmUrl = $utmGifLocation . "?" .
            ...
            "&utmvid=" . $visitorId .
            "&utmip="  . getIP($_SERVER["REMOTE_ADDR"]) .
            "&utmt="   . urlencode(@$_GET["utmt"]) .
            "&utmtid=" . urlencode(@$_GET["utmtid"]) .
            "&utmtst=" . urlencode(@$_GET["utmtst"]) .
            "&utmtto=" . urlencode(@$_GET["utmtto"]) .
            "&utmttx=" . urlencode(@$_GET["utmttx"]) .
            "&utmtsp=" . urlencode(@$_GET["utmtsp"]) .
            "&utmtci=" . urlencode(@$_GET["utmtci"]) .
            "&utmtrg=" . urlencode(@$_GET["utmtrg"]) .
            "&utmtco=" . urlencode(@$_GET["utmtco"]);
        break;
    case "item" :
        // e-commerce tracking (item)
        $utmUrl = $utmGifLocation . "?" .
            "utmwv="  . VERSION .
            "&utmn="  . getRandomNumber() .
            "&utmhn=" . urlencode($domainName) .
            ...
            "&utmt="   . urlencode(@$_GET["utmt"]) .
            "&utmtid=" . urlencode(@$_GET["utmtid"]) .
            "&utmipc=" . urlencode(@$_GET["utmipc"]) .
            "&utmipn=" . urlencode(@$_GET["utmipn"]) .
            "&utmiva=" . urlencode(@$_GET["utmiva"]) .
            "&utmipr=" . urlencode(@$_GET["utmipr"]) .
            "&utmiqt=" . urlencode(@$_GET["utmiqt"]);
        break;
    default :
        // Construct the gif hit url.
        $utmUrl = $utmGifLocation . "?" .
